...
const useLoadingSpinner = () => [null, () => {}, () => {}];
const FileUpload = () => <div>File Upload Placeholder</div>;
const uploadFile = () => {};
const StoredFileState = { Deleted: "Deleted" };
        ...
        onSubmit={(event) => {
          ...
          for (const editEntry of props.editEntries) {
            ...
            if (editEntry.type === EditEntryType.PillList) {
              // already stored in the entity state so we don't need to do anything here
              continue;
            }
          }
                  ...
                  if (!editEntry.type || editEntry.type == EditEntryType.Text) {
                    ...
                    return (
                      <PillList
                        ...
                        attribute={editEntry.attribute}
                        attributeName={editEntry.attributeName}
                        value={entity[editEntry.attribute]}
                        onChange={(newValue) => {
                          setEntity({
                            ...entity,
                            [editEntry.attribute]: newValue
                          });
                        }}
